...
<body>
  ...
  <div class="login-html">
    ...
    <div class="login-form">
      <form class="sign-in-htm" action="./api/user/capi.php?usuario=<?php echo $usuario; ?>&rol=<?php echo $rol; ?>" method="POST">
        <div class="group">
    ...
    <div class="group">
      ...
      <div class="group">
          <button class="button" style="position: absolute;top: 130%;" onclick="location.href='capacitaciones.php?usuario=<?php echo $usuario; ?>&rol=<?php echo $rol; ?>'">Volver</button>
      </div>
    </div>
  </div>
</div>
